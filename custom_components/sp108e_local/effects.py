"""SP108E effect mappings.

The mono/custom-color values are validated against LED Shop behavior for the
local controller. The preset list follows the SP108E public effect table used
by LED Shop-compatible controllers.
"""

from __future__ import annotations

MONO_EFFECTS: dict[str, int] = {
...
EFFECTS: dict[str, int] = {**MONO_EFFECTS, **PRESET_EFFECTS}
EFFECT_NAMES_BY_VALUE: dict[int, str] = {value: name for name, value in EFFECTS.items()}
SOLID_EFFECT = "Solid (custom color)"
